...
Much of the content you will enter will be simple text, numbers, or uploading an image.
...
In addition to formatted text, you can use what we call **[Short Codes](/gently-hugged/introduction/editing-content/short-codes/)**. Short Codes are special codes you can enter to represent larger, pre-formatted blocks of text. For example, if you want to show a list of all distribution sites on a page, all you need to do is enter `<DistributionSites />`. For a complete list of Short Codes and what they do, see this page.
